...
(() => {
  ...
  function injectHideStyle() {
    ...
    style.id = STYLE_ID;
    style.textContent = `
      /* Engagement bar: reply / repost / like / views / bookmark / share */
      article[data-testid="tweet"] [role="group"] { display: none !important; }
      /* Grok actions and translate prompts */
      article[data-testid="tweet"] [aria-label*="Grok" i],
      article[data-testid="tweet"] [data-testid="GrokTranslate"] { display: none !important; }
      ...
      /* Toasts and banners that could overlap the clip */
  ...
  function waitForImages(article, timeoutMs) {
    ...
    return new Promise((resolve) => {
      (function check() {
        ...
        if ((!pending && !spinner) || Date.now() > deadline) {
          // Small grace period so the full-res swap paints.
